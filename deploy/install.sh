...
RUST_DNS__DATABASE__PATH=/var/lib/rust-dns/rust-dns.db
RUST_DNS__DNS__BIND=0.0.0.0
RUST_DNS__DNS__PORT=53
RUST_DNS__API__BIND=0.0.0.0
RUST_DNS__API__PORT=8080
RUST_DNS__AUTH__JWT_SECRET=CHANGE_ME_REPLACE_WITH_RANDOM_SECRET
RUST_DNS__AUTH__JWT_EXPIRY_HOURS=24
EOF
